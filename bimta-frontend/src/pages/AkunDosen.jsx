...
const AkunDosen = () => {
  ...
  return (
    <MainLayout title="Mengelola Akun Dosen">
      {/* Header Section */}
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="flex-1">
            <SearchBar
              value={search}
              onChange={setSearch}
              placeholder="Cari dosen (Nama, NIDN, Email, dll...)"
            />
          </div>
      ...
      <Modal
        ...
        title={modalMode === 'create' ? 'Buat Akun Dosen Baru' : 'Edit Akun Dosen'}
        size="md"
      >
      ...
      >
        <div className="mb-4">
          <p className="text-sm text-gray-600 mb-4">
            Reset password untuk dosen: <strong>{selectedUser?.nama}</strong>
          </p>
